...
/// A map of Revset Aliases, usually defined in the `[revset-aliases]` toml table.
pub type RevsetAliasesMap = AliasesMap<RevsetAliasParser, String>;

/// A RevsetAliasesParser is responsible for parsing String expressions into Revset Aliases.
